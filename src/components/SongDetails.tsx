        ...
        <div className="flex gap-2">
          <div>
            <input
              ...
              maxLength={8}
              className={
                "text-gray-400 w-20 md:w-24 border-0  text-xs md:text-base  font-semibold focus:outline-none focus:border-b-2 focus:border-gray-400 " +
          ...
          <div>
            <input
              ...
              maxLength={6}
              className={
                "text-gray-400 border-0 w-12 font-semibold text-xs md:text-base [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none focus:outline-none focus:border-b-2 focus:border-gray-400 " +
